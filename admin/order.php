                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_array($query)) {
                                            ...
                                            <tr class="odd text-start fs14 w100pt border border-dark">
                                                ...
                                                ?>
                                                <td class="col-md-2 p10 border-end border-dark">
                                                    <p class="status-payment w100pt m-0">
                                                        <strong>
                                                            <?php echo htmlentities($row_payment['payment_name']) ?>
                                                        </strong> -
                                                        <?php echo htmlentities($row_payment['payment_status']) ?>
                                                    </p>
                                                </td>
                                        ...
                                        <!-- <tr class="even text-start fs14 w100pt border border-dark">
                                            <td class="col-md-1 p10 border-end border-dark">2</td>
                                            <td class="col-md-2 p10 border-end border-dark">
                                                <p class="customer w100pt m-0">
                                                    <strong>Id:</strong> 2
                                                </p>
                                                <p class="customer w100pt m-0">
                                                    <strong>Name:</strong> Cao Thị Cẩm Vân
                                                </p>
                                                <p class="customer w100pt m-0">
                                                    <strong>Email:</strong> camvansp@gmail.com
                                                </p>
                                                <p class="customer w100pt m-0">
                                                    <strong>Phone:</strong> 038 407 5036
                                                </p>
                                            </td>
                                            <td class="col-md-3 p10 border-end border-dark">
                                                <p class="product w100pt m-0">
                                                    <strong>Product: </strong>Pizza hải sản chấm mắm tôm
                                                    <small>x2</small>
                                                </p>
                                                <p class="product w100pt m-0">
                                                    <strong>Product: </strong>Pizza xúc xích chấm mắm tôm
                                                    <small>x2</small>
                                                </p>
                                            </td>
                                            <td class="col-md-3 p10 border-end border-dark">
                                            ...
                                            <td class="col-md-2 p10 border-end border-dark">
                                                <p class="status-payment w100pt m-0">
                                                    <strong>Chuyển khoản ngân hàng</strong> - Hoàn thành
                                                </p>
                                            </td>
                                            <td class="col-md-1 p10">
                                                <p class="w100pt m-0">
                                        ...
                                        <tr class="even text-start fs14 w100pt border border-dark">
                                            <td class="col-md-1 p10 border-end border-dark">3</td>
                                            <td class="col-md-2 p10 border-end border-dark">
                                                <p class="customer w100pt m-0">
                                                    <strong>Id:</strong> 3
                                                </p>
                                                <p class="customer w100pt m-0">
                                                    <strong>Name:</strong> Nguyễn Tiến Dương
                                                </p>
                                                <p class="customer w100pt m-0">
                                                    <strong>Email:</strong> duong2003@gmail.com
                                                </p>
                                                <p class="customer w100pt m-0">
                                                    <strong>Phone:</strong> 090 216 5142
                                                </p>
                                            </td>
                                            <td class="col-md-3 p10 border-end border-dark">
                                                <p class="product w100pt m-0">
                                            ...
                                            <td class="col-md-2 p10 border-end border-dark">
                                                <p class="status-payment w100pt m-0">
                                                    <strong>Nhận tiền giao hàng</strong> - Hoàn thành
                                                </p>
                                            </td>
                                            <td class="col-md-1 p10">
                                                <p class="w100pt m-0">
