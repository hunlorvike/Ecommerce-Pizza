                                ...
                                <div class="row order-control-item w100pt">
                                    ...
                                    <div class="col-md-6 order-control-item col-sm-6 text-center">
                                        <label for="search-order">
                                            <span>Search</span>
                                            <input type="text" class="px-1" name="" id="search-order" placeholder="Search order">
                                        </label>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <tr class="odd text-start fs14 w100pt border border-dark">
                                                ...
                                                <td class="col-md-2 p10">
                                                    <p class="w100pt m-0">
                                                        ...
                                                        <a href="manage-blog.php?id=<?php echo $row['post_id'] ?>&del=delete" onclick="return confirm('Are you sure you want to delete?')">
