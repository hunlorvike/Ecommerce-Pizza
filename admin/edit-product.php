...
if (strlen($_SESSION['adminlogin']) == 0) {
    ...
    //     $query = mysqli_query($con, "UPDATE tbl_product SET category_id = '$category', sub_id = '$subcategory', prod_name = '$product_name' , prod_old_price = '$price_old', prod_current_price = '$price_current', ship_price = '$product_ship', prod_desc = '$product_desc', prod_thumb = '$link_file_thumb', prod_img1 = '$link_file1',prod_img2 = '$link_file2',prod_img3 = '2'  WHERE prod_id = '$id'");
    //     // if (!$query) {
